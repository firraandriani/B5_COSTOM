...
<input type="checkbox" id="check">
    ...
    <div class="content">
        <div class="card">
            <h1>Ubah Stok Keluar Kakao</h1>
        </div>
        <div class="card_table">
            <div>
                <div class="kotak">
                <form action="<?= BASEURL ?>/Ubah_SKK/update" method="post">
                    <div class="form">
                    <div class="inputfield">
                            <input name="id_keluar_kakao" type="hidden" value="<?= $data['id_keluar_kakao'] ?? '' ?>">
                        </div>
                        <div class="inputfield">
                        ...
                        <div class="inputfield">
                            <label class="dataDiri">Stok Keluar(kg)</label>
                            <div style="width: 100%;">
