            ...
            <div>
                ...
                <div class="card_table2">
                    <table class="tabelMahasiswa" width="60%">
                        ...
                        <tr>
                            <th><?= ($key + 1) ?></th>
                            <th><?= $value['tanggal_masuk'] ?></th>
                            <th><?= $value['nama_produk'] ?></th>
                            <th><?= $value['stok_masuk'] ?></th>
                            <th><a class = 'edit' href = '<?= BASEURL;?>/ubah_SMP/<?= $value['id_masuk_produk']?>'><i class="fas fa-edit"></i> Ubah</a><a href="<?= BASEURL;?>/hapus_SMP/hapus/<?= $value['id_masuk_produk']?>" class="hapus"><i class="fas fa-trash"></i> Hapus</a></th>
                        </tr>
                        <?php } ?>
                    </table>
                    <br>
